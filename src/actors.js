export const HEROES = {
  guanyu: {
    ...
    passive: '高连击提升破甲，重击可斩杀残血敌军', weapon: '青龙偃月刀', atlasCols:4, atlasRows:3, artFacing:1, frameFacing:[-1,-1,-1,-1,-1,1,-1,-1,-1], frames: { idle:6, walk:[1,3], run:[0,3], jump:0, attack:[3,4], attack1:[3,4,3], attack2:[4,3,4], attack3:[3,4,5,4,3], skill:[5,4,5], ultimate:[5,4,5,3,5], hurt:8 }, motion:{attack:[.18,.22,.34],skill:.78,ultimate:1.25}
  },
  zhangfei: {
    ...
    passive: '受击积攒怒气，低生命时获得短暂霸体', weapon: '丈八蛇矛', atlasCols:4, atlasRows:3, artFacing:1, frames: { idle:6, walk:[1,0], run:[0,2], jump:2, attack:[3,5], attack1:[3,5,3], attack2:[5,3,5], attack3:[3,5,7,5,3], skill:[7,5,7], ultimate:[7,5,7,3,7], hurt:4 }, motion:{attack:[.2,.24,.42],skill:.86,ultimate:1.35}
  },
  zhaoyun: {
    ...
    passive: '空中攻击、冲刺和背击伤害提高', weapon: '龙胆亮银枪', atlasCols:4, atlasRows:3, artFacing:1, frames: { idle:0, walk:[1,4], run:[3,6], jump:2, attack:[0,3], attack1:[0,3,0], attack2:[3,0,3], attack3:[0,3,5,3,0], skill:[5,3,5], ultimate:[5,3,5,0,5], hurt:7 }, motion:{attack:[.16,.2,.3],skill:.72,ultimate:1.15}
  },
  huangzhong: {
    ...
    passive: '距离越远伤害越高，暴击返还能量', weapon: '万石弓', atlasCols:4, atlasRows:3, artFacing:-1, frames: { idle:6, walk:[1,0], run:[0,1], jump:3, attack:[4,7], attack1:[4,7,4], attack2:[7,4,7], attack3:[4,7,5,7,4], skill:[5,7,5], ultimate:[5,7,5,4,5], hurt:3 }, motion:{attack:[.2,.24,.38],skill:.82,ultimate:1.3}
  }
};
